...
export default function Register() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    try {
      ...
      toast({ variant: "destructive", title: "Registration failed", description: "Something went wrong. Try again." });
    } finally {
      setLoading(false);
    }
  }
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>One account for you and your business</CardDescription>
          </CardHeader>
          <CardContent>
